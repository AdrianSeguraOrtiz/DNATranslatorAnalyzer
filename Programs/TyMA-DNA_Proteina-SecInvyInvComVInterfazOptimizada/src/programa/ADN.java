...
public class ADN {
	...
	public String getSecuenciaInvCom() {
		return secuenciaInvCom;
	}

	public DiagramaBarras getDiagramaBarras() {
	...
	public String[] getLongitudesText() {
		return longitudesText;
	}

	public Histograma[] getHistogramas() {
		return histogramas;
	}
